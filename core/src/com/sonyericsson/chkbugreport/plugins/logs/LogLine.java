...
public class LogLine extends DocNode {
    ...
    private boolean parseFmtBrat(BugReportModule br, String line) {
        ...
        //mod by john
        int pidS = line.indexOf(' ', 24);
        int pidE = line.indexOf(' ', 30);
        // Parse pid
        //int pidS = 19;
        //int pidE = 24;
        //end
        ...
        int startIndex = line.indexOf(' ', 36);
        level = Util.strip(line.substring(startIndex + 1, startIndex + 2)).charAt(0);
        //end

        // Parse tag
        //mod by john
        //int tagS = 33;
        int tagE = line.indexOf(':', 40);
        int tagS = line.lastIndexOf(' ', tagE - 8);
        //end
        if (tagE < 0) return false;
        int realE = tagE;
