...
public class Section extends Lines {
    ...
    //add by john
    public static final String ACTIVITY_SERVICES = "ACTIVITY MANAGER SERVICES";
    public static final String ACTIVITY_SETTINGS = "ACTIVITY MANAGER SETTINGS";
    public static final String ACTIVITY_PROCESSES = "ACTIVITY MANAGER RUNNING PROCESSES";
    public static final String DUMP_OF_SERVICE_GFXINFO = "DUMP OF SERVICE gfxinfo";
    //end
    ...
    public static final String DUMP_OF_SERVICE_MEMINFO = "DUMPSYS MEMINFO"; //mod by john
    ...
    public static final String DUMP_OF_SERVICE_INPUT = "DUMP OF SERVICE input"; //add by john
    ...
    public static final String DUMP_OF_CPUINFO = "DUMPSYS CPUINFO"; //add by john
    public static final String CPU_TOP_INFO = "CPU INFO";//add by john
